...
"string")h.apply(this,Galleria.utils.array(arguments));else{var a=this,b=Galleria.utils.array(arguments),c=this._options.flickr.split(":"),d,i=e.extend({},a._options.flickrOptions),f=typeof i.loader!=="undefined"?i.loader:e("<div>").css({width:43,height:11,opacity:1,background:"white url("+j+"loader.gif) no-repeat 50% 50%"});if(c.length){if(typeof Galleria.Flickr.prototype[c[0]]!=="function")return Galleria.raise(c[0]+" method not found in Flickr plugin"),h.apply(this,b);if(!c[1])return Galleria.raise("No flickr argument found"),
